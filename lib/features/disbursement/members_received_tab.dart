...
class MembersReceivedTab extends StatefulWidget {
  final Group group;
  const MembersReceivedTab({super.key,required this.group});

  @override
  State<MembersReceivedTab> createState() => _MembersReceivedTabState();
}

class _MembersReceivedTabState extends State<MembersReceivedTab> {
  ...
  void filterMembers(String query) {
    final memberProvider = Provider.of<MemberProvider>(context, listen: false);
    memberProvider.filterMembersReceived(query);
  }

  void sortMembers(bool ascending) {
    final memberProvider = Provider.of<MemberProvider>(context, listen: false);
    memberProvider.sortMembersReceived(ascending);
  ...
  Widget build(BuildContext context) {
    ...
    final membersReceived = memberProvider.filteredMembersReceived;   //membersReceived;
            ...
            children: [
              ...
              Expanded(
                child: ListView.builder(
                    itemCount: membersReceived.length,
                    itemBuilder: (context, index) {
                      MyMember member = membersReceived[index];
                      return MemberCard(
                        member: member,
                      );
                    }
